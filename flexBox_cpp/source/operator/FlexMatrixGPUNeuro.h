#ifndef flexMatrixGPUNeuro_H
#define flexMatrixGPUNeuro_H
...
template<typename T>
class flexMatrixGPUNeuro : public flexLinearOperator<T>
{
...
public:
	...
	*/
	flexMatrixGPUNeuro(int  aNumRows, int  aNumCols, int* rowList, int* colList, T* indexVal, bool formatCRS, bool aMinus) : flexLinearOperator<T>(aNumRows, aNumCols, matrixGPUOp, aMinus)
	{
