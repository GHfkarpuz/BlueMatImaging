...
img1_np = img1_np + 5.0 * np.random.randn(*img1_np.shape)
img2_np = img2_np + 5.0 * np.random.randn(*img2_np.shape)
...
# initialise solver
solver = FlexBoxSolver(maxIt=3000, tol=1e-6, verbose=2)
...
plt.savefig("resultL2TVOpticalFlowNoisy.png", dpi=200, bbox_inches="tight")